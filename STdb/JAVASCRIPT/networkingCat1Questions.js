...
const networkingCat1Questions = [
    {
        networkingCat1Question: "which one is not part of PHP bind_param().",
    ...
    {
        networkingCat1Question: "How long can it take you to build this online quiz app.",
        networkingCat1Answers: [
            { txt: "one day", correct: true },
            { txt: "not sure", correct: false },
            { txt: "two days", correct: false },
        ]
    },
    {
        networkingCat1Question: "Which is your all time dream laptop",
        networkingCat1Answers: [

...
<body>
    ...
    <main>
        <article>
            <section><button onclick="openJoinRoom()" id="joinRoombtn">Join Room.</button><button onclick="openCreateRoom()" id="createRoombtn">Create Room.</button></section>
        </article>
        <article id="createRoomArticle">
            <section>
                <form method="POST" action="../ACTIONS/createRoom.php">
                    <fieldset>
        ...
        <article id="joinRoomArticle">
            <section>
                <form method="POST" action="../ACTIONS/joinRoom.php">
                    <fieldset>
                        <legend>Fill in all the details.</legend>
                        <label for="roomNo" class="txt">Room Number.</label><br>
                        <input type="text" id="roomNo" name="roomNo" class="txt" placeholder="mjRoom202" required><br><br>

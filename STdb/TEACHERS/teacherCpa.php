...
<link rel="icon" href="../IMAGES/schoolLogo.jpg" type="image/x-icon">
    ...
    <body>
        ...
        <div class="bodyContainer">
            <form id="frm" method="POST" action = "../ACTIONS/teacherCpaAssignmentUpload.php" enctype="multipart/form-data">
                <div id="input">
                    <p id="uploadAssignment">
                        Upload an Assignment/Notes.
                    </p>
                    <input type="file" name="teacherCpaFile" id="myTeacherfile" required>
                    <br><br>
                    <input type="text" id="descriptionn" name="describE" placeholder="Name the assignment here..." required>
                </div><br>
                    <input type="submit" id="sbmt" name="submit" value="Upload the File!"><br>
            </form><br>
            <div class="userData">
                <a class="userData" href = "gradeCpa.php">Add Course Work.</a>   <a class="userData" href = "finalGradeCpa.php">Add Final Grade.</a>
            </div><hr><hr>
            <?php
                $sql = "SELECT studentFile,describee,studentEmail from studentCpaAssignmentUpload";
            ...
            ?>
                ...
                <br><br>
                <a href = "../StudentFile/<?php echo $info['studentFile']; ?> " ><?php echo $info['describee'];?></a><br><br><hr>
            <?php
                }
            ?>

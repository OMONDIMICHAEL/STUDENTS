...
<link rel="icon" href="../IMAGES/schoolLogo.jpg" type="image/x-icon">
    ...
    <article class="bodyContainer">
        ...
        <section class="quiz">
            ...
            <!-- //////////////////////////////////////////////////////// -->
            <form method="post" action="../ACTIONS/submitNetworkingCat1.php">
                <input type="text" name="catScore" id="scores" style="display:none;">
                <input type="text" value="Networking" name="userUnit" id="userUnit" style="display:none;">
    ...
    <script src = "../JAVASCRIPT/networkingCat1Questions.js"></script>   

...
// ///////////////////////////////////////////////////////////////
$atd2Query = ("INSERT INTO atd2(no,day,time,room,hours,lecname,unitname,unitcode) values('$number','$day','$time','$room','$hours','$lecname','$unitname','$unitcode')");
mysqli_query($con,$atd2Query);

...
// ///////////////////////////////////////////////////////////////
$dit2Query = ("INSERT INTO dit2(no,day,time,room,hours,lecname,unitname,unitcode) values('$number','$day','$time','$room','$hours','$lecname','$unitname','$unitcode')");
mysqli_query($con,$dit2Query);

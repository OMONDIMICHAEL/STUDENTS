...
// ///////////////////////////////////////////////////////////////
$cit1Query = ("INSERT INTO cit1(no,day,time,room,hours,lecname,unitname,unitcode) values('$number','$day','$time','$room','$hours','$lecname','$unitname','$unitcode')");
mysqli_query($con,$cit1Query);

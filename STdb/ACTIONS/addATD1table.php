...
// ///////////////////////////////////////////////////////////////
$atd1Query = ("INSERT INTO atd1(no,day,time,room,hours,lecname,unitname,unitcode) values('$number','$day','$time','$room','$hours','$lecname','$unitname','$unitcode')");
mysqli_query($con,$atd1Query);

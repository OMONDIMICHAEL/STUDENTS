...
// ///////////////////////////////////////////////////////////////
$management2Query = ("INSERT INTO management2(no,day,time,room,hours,lecname,unitname,unitcode) values('$number','$day','$time','$room','$hours','$lecname','$unitname','$unitcode')");
mysqli_query($con,$management2Query);
